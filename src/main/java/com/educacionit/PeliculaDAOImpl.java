...
public class PeliculaDAOImpl implements PeliculaDAO {
    ...
    public PeliculaDAOImpl(DBManager dbManager) {
        this.dbManager = dbManager;
    }
    
    public PeliculaDAOImpl(String url, String usuario, String contraseña) {
        this.dbManager = new DBManager(url, usuario, contraseña);
    }
